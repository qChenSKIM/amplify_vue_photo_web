  ...
  <div>
    <form v-if="!confirmPassword" class="flex flex-col items-center" @submit.prevent="signUp">
      <div class="flex flex-col user">
        ...
        <input
          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-xl"
          type="text"
          v-model="username"
          id="userName"
        />
      ...
      <div class="flex flex-col mt-2">
        ...
        <input
          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-xl"
          type="password"
          id="password"
          v-model="password"
        />
    ...
    <div v-if="confirmPassword" class="w-4/12 m-auto">
      ...
      <div class="flex flex-col mt-2">
        ...
        <input
          class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-xl"
          type="text"
          v-model="code"
        />
